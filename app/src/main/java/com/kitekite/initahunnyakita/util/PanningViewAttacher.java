...
public class PanningViewAttacher implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public OnPanningEndListener onPanningEndListener;
    ...
    public void setOnPanningEndListener(OnPanningEndListener onPanningEndListener) {
        this.onPanningEndListener = onPanningEndListener;
    }
